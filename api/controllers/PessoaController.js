...
class PessoasController {
    ...
    static async pegarUmaPessoa (req, res){
        const { id } = req.params; //id dos parâmetros da req  

        try {
            const umaPessoa = await database.Pessoas.findOne({
              where: {
                id: Number(id) //id da coluna da tabela
              },
            });
    ...
    static async atualizarPessoa (req, res){
        ...
        try {
            await database.Pessoas.update(novasInfos, { where: {id: Number(id) }}) //id da coluna da tabela
